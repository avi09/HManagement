...
<%@ page  import="java.sql.*" import="databaseconnection.*"%><!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
try
{
if ((username.equals("labs") && key.equals("labs")))
{
	session.setAttribute("labs", "true");
...
for (Map.Entry<String,ArrayList> entry : categoryfields.entrySet())
{
	...
	while (rs.next())
	{
		...
		+"<input type='hidden' name='source' value='labs'/>");
